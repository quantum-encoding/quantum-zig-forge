...
pub fn build(b: *std.Build) void {
    ...
    test_exec_exe.linkSystemLibrary("mbedtls");
    test_exec_exe.linkSystemLibrary("mbedx509");
    test_exec_exe.linkSystemLibrary("mbedcrypto");
    test_exec_exe.linkLibC();
    ...
    // Link mbedTLS for TLS support
    test_tls_exe.linkSystemLibrary("mbedtls");
    test_tls_exe.linkSystemLibrary("mbedx509");
    test_tls_exe.linkSystemLibrary("mbedcrypto");
    test_tls_exe.linkLibC();
    ...
    // Link mbedTLS for TLS support
    test_exchange_exe.linkSystemLibrary("mbedtls");
    test_exchange_exe.linkSystemLibrary("mbedx509");
    test_exchange_exe.linkSystemLibrary("mbedcrypto");
    test_exchange_exe.linkLibC();
