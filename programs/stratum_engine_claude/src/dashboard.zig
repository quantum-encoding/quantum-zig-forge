...
pub const Dashboard = struct {
    ...
    pub fn run(self: *Self) !void {
        ...
        while (self.running.load(.acquire)) {
            ...
            std.posix.nanosleep(0, self.refresh_interval_ns);
        }
    ...
    fn printMiningStats(self: *Self, writer: anytype, engine: *MiningEngine, last_hashes: *u64, timer: *std.time.Timer) !void {
        _ = self;
    ...
    fn printMempoolStats(self: *Self, writer: anytype, monitor: *MempoolMonitor, last_tx: *u64, timer: *std.time.Timer) !void {
        _ = self;
