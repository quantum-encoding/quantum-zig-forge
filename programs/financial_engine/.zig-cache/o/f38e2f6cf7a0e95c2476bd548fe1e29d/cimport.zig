...
pub fn vprintf(noalias arg___fmt: [*c]const u8, arg___arg: [*c]struct___va_list_tag_1) callconv(.c) c_int {
    var __fmt = arg___fmt;
    _ = &__fmt;
    var __arg = arg___arg;
    _ = &__arg;
...
pub fn getc_unlocked(arg___fp: ?*FILE) callconv(.c) c_int {
    var __fp = arg___fp;
    _ = &__fp;
    const extern_local___uflow = struct {
        extern fn __uflow(?*FILE) c_int;
    };
...
pub fn fgetc_unlocked(arg___fp: ?*FILE) callconv(.c) c_int {
    var __fp = arg___fp;
    _ = &__fp;
    const extern_local___uflow = struct {
        extern fn __uflow(?*FILE) c_int;
...
pub fn fputc_unlocked(arg___c: c_int, arg___stream: ?*FILE) callconv(.c) c_int {
    var __c = arg___c;
    _ = &__c;
    var __stream = arg___stream;
    _ = &__stream;
    const extern_local___overflow = struct {
        extern fn __overflow(?*FILE, c_int) c_int;
    };
...
pub fn putc_unlocked(arg___c: c_int, arg___stream: ?*FILE) callconv(.c) c_int {
    var __c = arg___c;
    _ = &__c;
    var __stream = arg___stream;
    _ = &__stream;
...
pub fn feof_unlocked(arg___stream: ?*FILE) callconv(.c) c_int {
    var __stream = arg___stream;
    _ = &__stream;
    return @intFromBool((__stream.*._flags & @as(c_int, 16)) != @as(c_int, 0));
}
pub fn ferror_unlocked(arg___stream: ?*FILE) callconv(.c) c_int {
    var __stream = arg___stream;
    _ = &__stream;
...
pub const __INTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // <builtin>:166:9
pub const __UINTMAX_TYPE__ = c_ulong;
pub const __UINTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:168:9
...
pub const __UINT64_FMTX__ = "lX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:219:9
