...
```zig
headers.append("APCA-API-KEY-ID", "PKHCX1EU4AQ2YTLBNRV9") catch unreachable;
headers.append("APCA-API-SECRET-KEY", "GxJtN5QhxaGg3cQ2URV9zTG7qiV3RlJnyigK3ZgQ") catch unreachable;
```
