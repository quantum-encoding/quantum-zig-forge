...
pub fn Server(comptime H: type) type {
    return struct {
        ...
        pub fn listen(self: *Self, ctx: anytype) !void {
            ...
            if (no_delay) {
                // Platform-specific TCP_NODELAY implementation
                // Darwin compatibility issue tracked at: https://github.com/ziglang/zig/issues/17260
                // Using direct constant value (1) for TCP_NODELAY until cross-platform support improves
