...
pub const perf_buffer_event_fn = ?*const fn (ctx: ?*anyopaque, cpu: c_int, event: ?*struct_perf_event_header) callconv(.c) enum_bpf_perf_event_ret; // /usr/local/zig/lib/compiler/aro/include/stdarg.h:3:2: warning: struct demoted to opaque type - has bitfield
...
const union_unnamed_159 = extern union {
    perf_event: struct_unnamed_160,
    kprobe_multi: struct_unnamed_161,
    uprobe_multi: struct_unnamed_162,
    tracing: struct_unnamed_163,
    netfilter: struct_unnamed_164,
    tcx: struct_unnamed_165,
    netkit: struct_unnamed_166,
}; // /usr/local/zig/lib/compiler/aro/include/stdarg.h:3:2: warning: struct demoted to opaque type - has bitfield
